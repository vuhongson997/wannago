...
class HostController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        */
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allHost','hostForStay'));
    }
    ...
    {   
        ...
        $dataType = Voyager::model('DataType')->where('slug', '=', $slug)->first();
        $dataType1 = Voyager::model('DataType')->where('slug', '=','t-room-gallery')->first();
        ...
        */
        ...
        TStay::updateOrCreate(['stay_id'=> $id],[
    ...
    public function create(Request $request)
    {
        ...
        */
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allHost'));
    }
